...
#define NODE_MAIN_LOGGER_NAME "a_star_component"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liba_star_planner.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<AStarGlobalPlanner>";

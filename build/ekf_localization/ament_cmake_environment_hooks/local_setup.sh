...
: ${AMENT_CURRENT_PREFIX:="/home/suke/chicken_core/install/ekf_localization"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ekf_localization/environment/library_path.sh"
